...
const UserValidationMessage = {
	...
	ONLY_LATIN: "Latin letters only.",
	PASSWORD_COMPLEXITY:
		"Password must include at least one uppercase letter, one lowercase letter, one number, and one special character (Latin letters only).",
